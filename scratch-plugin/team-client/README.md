...
- Harness Git synchronization: `tools/post-execute` uploads the operation type and each successful commit's hash, subject, origin remote, commit time, and change counts in `src/git-sync.ts`.
